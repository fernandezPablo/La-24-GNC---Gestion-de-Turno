...
Vue.component('query-turns',require('./components/QueryTurnsComponent.vue').default);
...
import QueryTurns from './components/QueryTurnsComponent'
...
const routes = [
    ...
    {path: '/consultarTurno', name: 'checkTurn', component: QueryTurns, props: true},
